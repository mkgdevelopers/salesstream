          ...
          <div className="row  justify-content-center">
            <div className="col-lg-10">
              <div className="appie-hero-content text-center">
                ...
                <p>
                  Efficiently manage affiliates, automate commissions, and gain
                  full visibility into performance. Boost productivity, improve
                  cash flow, and scale confidently — all from one centralized
                  platform.
                </p>
